...
work_id: WF-20260613-forma-2026-06-13-v1
requirement: # Forma 生图能力需求设计文档
...
## Evidence Block
keywords_hit: ['重写', '迁移', '移植', 'react', 'project', '删除', '清空', '截断', '鉴权', '登录', '权限', '凭证', 'token', '计费', 'token', '接入', '调用', '依赖', 'mcp', 'mcp', '全部', '所有', '全套']
repo_baseline_summary: loc=124071, modules=86, monorepo=True, languages=['TypeScript', 'JavaScript']
linked_context: - https://ark.cn-beijing.volces.com/api/v3`）+: unreachable
  error: URL fetching disabled
- https://ark.cn-beijing.volces.com/api/v3: unreachable
  error: URL fetching disabled
- https://www.volcengine.com/docs/82379/1330310: unreachable
  error: URL fetching disabled
- https://www.volcengine.com/docs/82379/1541523: unreachable
  error: URL fetching disabled
- https://www.volcengine.com/docs/82379/1824121: unreachable
  error: URL fetching disabled
scope_signals: ['全部', '所有', '全套']
