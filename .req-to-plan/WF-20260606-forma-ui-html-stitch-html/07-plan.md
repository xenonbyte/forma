...
r2p_version: 3
r2p_status: approved
r2p_created_at: 2026-06-06T10:10:40.833029+00:00
r2p_updated_at: 2026-06-06T10:36:05.350439+00:00
---
...
Scope Closure: SCOPE-IN-001 [ADDRESSED]
Change Type: modify
TDD Applicable: yes
Files:
...
Scope Closure: SCOPE-IN-003 [ADDRESSED]
Change Type: modify
TDD Applicable: yes
Files:
...
Scope Closure: SCOPE-IN-003 [ADDRESSED], SCOPE-IN-005 [ADDRESSED]
Change Type: modify
TDD Applicable: yes
Files:
...
```
Steps:
- [ ] 先把 ViewerPage.test.tsx 的 `vi.mock("@xenonbyte/forma-viewer")` 模式迁入 DesignView.test.tsx（样板文件随后删除；注意 mock 对象由 `Viewer` 换成 `Canvas`，`buildViewerModel` 保持透传）
...
Verification: npx vitest run packages/web/src/pages/DesignView.test.tsx packages/web/src/routes.test.ts && ! rg -n "ViewerPage" packages/web/src --glob '!**/dist/**'

### PLAN-TASK-006 web：WorkSurface actions 槽
Spec References: SPEC-BEHAVIOR-008
Scope Closure: SCOPE-IN-004 [ADDRESSED]
Change Type: modify
TDD Applicable: yes
Files:
...
Scope Closure: SCOPE-IN-004 [ADDRESSED], SCOPE-IN-005 [ADDRESSED]
Change Type: modify
TDD Applicable: yes
Files:
...
Scope Closure: SCOPE-IN-002 [ADDRESSED]
Change Type: modify
TDD Applicable: yes
Files:
...
Scope Closure: SCOPE-IN-006 [ADDRESSED]
Change Type: modify
TDD Applicable: no
Files:
- packages/web/src/i18n.ts
