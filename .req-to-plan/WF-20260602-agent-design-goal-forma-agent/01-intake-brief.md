...
work_id: WF-20260602-agent-design-goal-forma-agent
requirement: # 设计稿切图导出 + 开发 agent 定稿访问控制 Design
---
...
## Evidence Block
keywords_hit: ['重写', '转换', '替代', '替换', 'c', 'react', 'fastify', 'wasm', 'project', '清理', '鉴权', '角色', 'token', 'token', '接入', '集成', '调用', '依赖', 'mcp', 'mcp', '全部', '所有']
