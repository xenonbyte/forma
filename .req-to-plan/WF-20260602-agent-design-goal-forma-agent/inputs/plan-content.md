...
|---|---|---|---|---|---|
| SPEC-FR-001, SPEC-IF-001, SPEC-DATA-006, SPEC-EDGE-001, SPEC-EDGE-002, SPEC-EDGE-003 | SPEC icons contract | PLAN-TASK-003, PLAN-TASK-004 | implementation + unit tests | covered | deterministic icon files, manifest, zero-icon, dedupe, viewBox sizing |
| SPEC-FR-002, SPEC-DATA-004, SPEC-ERR-001, SPEC-ERR-006, SPEC-ACC-001, SPEC-ACC-002, SPEC-ACC-007 | SPEC archive contract | PLAN-TASK-005, PLAN-TASK-006 | implementation + integration tests | covered | generation succeeds before archive commit; failure leaves non-archived |
| SPEC-FR-003, SPEC-IF-002, SPEC-DATA-002, SPEC-ERR-003, SPEC-EDGE-004 | SPEC VZI capture | PLAN-TASK-001, PLAN-TASK-005 | implementation + smoke tests | covered | vendor VZI path and capture metadata/viewport |
| SPEC-DATA-001, SPEC-COMPAT-003 | SPEC storage compatibility | PLAN-TASK-002, PLAN-TASK-004, PLAN-TASK-005 | implementation + compatibility tests | covered | generated sibling dirs; version dirs unchanged |
| SPEC-DATA-003, SPEC-ERR-002, SPEC-ACC-006, SPEC-EDGE-007 | SPEC icon/VZI linking | PLAN-TASK-003, PLAN-TASK-005, PLAN-TASK-008 | implementation + link tests | covered | manifest-driven assetRef and missing-asset errors |
| SPEC-FR-004, SPEC-IF-003, SPEC-IF-004, SPEC-IF-005, SPEC-IF-006, SPEC-DATA-005, SPEC-ERR-004 | SPEC dev MCP handoff | PLAN-TASK-008 | implementation + MCP tests | covered | archived gate and read-only VZI projection |
| SPEC-FR-005, SPEC-FR-006, SPEC-COMPAT-001, SPEC-COMPAT-002, SPEC-ACC-005 | SPEC access preservation | PLAN-TASK-010 | preserve + regression tests | covered | HTTP and design MCP tools stay ungated |
| SPEC-FR-007, SPEC-IF-007, SPEC-ERR-005, SPEC-COMPAT-004, SPEC-EDGE-006 | SPEC manual export | PLAN-TASK-009 | implementation + MCP tests | covered | `icons`/`vzi` export without archive mutation |
| SPEC-IF-008, SPEC-OBS-001, SPEC-OBS-002, SPEC-OBS-004, SPEC-OBS-005 | SPEC responses/observability | PLAN-TASK-006, PLAN-TASK-007, PLAN-TASK-009 | implementation + UI/API tests | covered | response counts and retryable errors |
| SPEC-SAFE-001, SPEC-SAFE-006, RISK-RIS-006 | SPEC soft gate and path safety | PLAN-TASK-008, PLAN-TASK-011 | implementation + template/docs checks | covered | tool descriptions and returned paths stay scoped |
| SPEC-SAFE-002 | SPEC mutation safety | PLAN-TASK-006 | preserve + server tests | covered | archive route keeps mutation-origin and ownership checks |
| SPEC-SAFE-003, SPEC-PLAN-015 | SPEC SVG safety | PLAN-TASK-003 | unit tests | covered | unsafe SVG fails extraction/generation |
| SPEC-SAFE-004, SPEC-COMPAT-005, SPEC-COMPAT-008, SPEC-PLAN-011, SPEC-PLAN-017 | SPEC vendor/dependency boundary | PLAN-TASK-001, PLAN-TASK-012 | implementation + build/import checks | covered | package boundary, docs drift handling, build/typecheck |
| SPEC-SAFE-005, SPEC-COMPAT-006, SPEC-PLAN-012 | SPEC dormant renderer | PLAN-TASK-001, PLAN-TASK-012 | implementation + import-boundary check | covered | renderer buildable and not imported by runtime paths |
| SPEC-COMPAT-007 | SPEC historical archived data | PLAN-TASK-008, PLAN-TASK-009 | explicit preserve | covered | missing generated handoff errors; no automatic backfill |
| SPEC-PLAN-001 through SPEC-PLAN-017 | SPEC Plan Inputs | PLAN-TASK-001 through PLAN-TASK-012 | implementation + verification + safety | covered | all SPEC Plan Inputs have task coverage below |
...
|---|---|---|---|---|---|
| RISK-PLAN-001: archive all-or-nothing verification | DES-PLAN-002 | SPEC-PLAN-002 | PLAN-TASK-005, PLAN-TASK-006 | covered | injected failure tests before archive commit |
| RISK-PLAN-002: temp directory and retry verification | DES-PLAN-012 | SPEC-PLAN-014 | PLAN-TASK-004, PLAN-TASK-005 | covered | temp publish, stale output replacement, rollback notes |
| RISK-PLAN-003: VZI/icon linking verification | DES-PLAN-011 | SPEC-PLAN-013, SPEC-PLAN-016 | PLAN-TASK-003, PLAN-TASK-005, PLAN-TASK-008 | covered | manifest occurrences and resolved asset paths |
| RISK-PLAN-004: workspace build and dependency verification | DES-PLAN-009, DES-PLAN-010 | SPEC-PLAN-011, SPEC-PLAN-012, SPEC-PLAN-017 | PLAN-TASK-001, PLAN-TASK-012 | covered | package build/typecheck and renderer import boundary |
| RISK-PLAN-005: access-boundary regression tests | DES-PLAN-008 | SPEC-PLAN-009, SPEC-PLAN-010 | PLAN-TASK-010 | covered | HTTP/design MCP ungated regressions |
| RISK-PLAN-006: external-doc verification before code | DES-PLAN-009 | SPEC-PLAN-011 | PLAN-TASK-001, PLAN-TASK-012 | covered | re-check docs only if dependency versions changed; otherwise use tests |
| RISK-PLAN-007: VZI conformance smoke | DES-PLAN-004 | SPEC-PLAN-004 | PLAN-TASK-005 | covered | parse/transform/encode/decode with non-zero bounds |
...
Spec References:
- SPEC-FR-003: generated VZI output for archived pages.
- SPEC-IF-002: VZI file metadata and content contract.
- SPEC-COMPAT-005: exclude VZI platform/Figma/quality-lab/standalone MCP runtime.
- SPEC-COMPAT-006: dormant renderer does not affect React 19 runtime.
- SPEC-COMPAT-008: vendored VZI source boundary.
- SPEC-SAFE-004: dependency behavior must be verified.
- SPEC-SAFE-005: renderer must not be imported by server/CLI/core/MCP handoff paths.
- SPEC-PLAN-011, SPEC-PLAN-012, SPEC-PLAN-017.
...
Verification:
Run `pnpm --filter @vzi-core/types build`, `pnpm --filter @vzi-core/parser build`, `pnpm --filter @vzi-core/transformer build`, `pnpm --filter @vzi-core/format build`, and `pnpm --filter @vzi-core/renderer build`. These checks cover SPEC-COMPAT-008 and SPEC-COMPAT-006.
...
Spec References:
- SPEC-DATA-001: generated handoff assets are sibling state.
- SPEC-COMPAT-003: version listing reports only `v{n}` directories.
- SPEC-PLAN-003: storage helper tests.
...
Verification:
Targeted tests pass and prove SPEC-DATA-001 and SPEC-COMPAT-003.
...
Spec References:
- SPEC-FR-001: archive generates complete `icons/`.
- SPEC-IF-001: icon output interface.
- SPEC-DATA-006: `icons.json` manifest state.
- SPEC-SAFE-003: unsafe generated SVG must not succeed.
- SPEC-EDGE-001, SPEC-EDGE-002, SPEC-EDGE-003.
- SPEC-PLAN-001, SPEC-PLAN-015, SPEC-PLAN-016.
...
Verification:
Unit tests prove SPEC-IF-001, SPEC-DATA-006, SPEC-SAFE-003, and edge cases.
...
Spec References:
- SPEC-FR-001: complete page-level icons before archive success.
- SPEC-DATA-001: generated sibling state.
- SPEC-DATA-004: retry replaces stale outputs.
- SPEC-ERR-001: icon extraction/write failures fail archive.
- SPEC-PLAN-002, SPEC-PLAN-014.
...
Verification:
Tests prove retry, temp publish, and failure semantics for SPEC-DATA-004 and SPEC-ERR-001.
...
Spec References:
- SPEC-FR-002, SPEC-FR-003: archive assets complete before status commit.
- SPEC-IF-002: VZI output interface.
- SPEC-DATA-002: viewport mapping.
- SPEC-DATA-003: VZI resource refs derive from icon manifest.
- SPEC-ERR-001, SPEC-ERR-002, SPEC-ERR-003.
- SPEC-EDGE-004, SPEC-EDGE-007.
- SPEC-PLAN-004, SPEC-PLAN-013, SPEC-PLAN-014.
...
Verification:
Core tests prove SPEC-IF-002, SPEC-DATA-002, SPEC-DATA-003, SPEC-ERR-002, and SPEC-ERR-003.
...
Spec References:
- SPEC-FR-002: status becomes archived only after assets succeed.
- SPEC-IF-008: archive HTTP response summary.
- SPEC-DATA-004: archive state transition.
- SPEC-ERR-001, SPEC-ERR-006.
- SPEC-SAFE-002: mutation origin and ownership checks preserved.
- SPEC-ACC-001, SPEC-ACC-002, SPEC-ACC-007.
- SPEC-PLAN-002, SPEC-PLAN-005.
...
Spec References:
- SPEC-IF-008: archive response includes icons and VZI summaries.
- SPEC-OBS-001: successful archive responses expose counts.
- SPEC-OBS-002: archive errors expose retryable context.
- SPEC-ACC-001, SPEC-ACC-007.
- SPEC-PLAN-005.
...
Verification:
Web tests prove SPEC-OBS-001 and SPEC-OBS-002 without changing existing navigation or requirement reload behavior.

Rollback / Safety:
UI change is additive. Stop if count display requires changing the archive API beyond SPEC-IF-008.

### PLAN-TASK-008: Add gated development MCP handoff and VZI read tools

Spec References:
- SPEC-FR-004: development MCP handoff serves only archived requirements.
- SPEC-IF-003, SPEC-IF-004, SPEC-IF-005, SPEC-IF-006.
- SPEC-DATA-005: read-only VZI data.
- SPEC-ERR-004: missing generated handoff files are explicit errors.
- SPEC-SAFE-001, SPEC-SAFE-006.
- SPEC-COMPAT-007.
- SPEC-ACC-003, SPEC-ACC-004, SPEC-ACC-006.
- SPEC-PLAN-006, SPEC-PLAN-007, SPEC-PLAN-013.
...
Spec References:
- SPEC-FR-007: manual export for debugging.
- SPEC-IF-007: `icons`/`vzi` export interface.
- SPEC-ERR-005: manual export failure does not change requirement status.
- SPEC-COMPAT-004: existing export behavior remains compatible.
- SPEC-EDGE-006.
- SPEC-PLAN-008.
...
Verification:
MCP export tests prove SPEC-IF-007, SPEC-ERR-005, and SPEC-COMPAT-004.
...
Spec References:
- SPEC-FR-005: HTTP preview/admin clients remain available.
- SPEC-FR-006: existing MCP design tools remain available.
- SPEC-COMPAT-001, SPEC-COMPAT-002.
- SPEC-ACC-005.
- SPEC-PLAN-009, SPEC-PLAN-010.
...
Verification:
Regression tests prove SPEC-COMPAT-001 and SPEC-COMPAT-002.
...
Spec References:
- SPEC-SAFE-001: gate is soft isolation and must be documented as a guard, not hard authorization.
- SPEC-FR-004: development handoff uses archived requirements only.
- SPEC-IF-003, SPEC-IF-004, SPEC-IF-005.
...
Spec References:
- SPEC-SAFE-004: dependency behavior verified.
- SPEC-SAFE-005: renderer no runtime import.
- SPEC-COMPAT-006, SPEC-COMPAT-008.
- SPEC-PLAN-011, SPEC-PLAN-012, SPEC-PLAN-017.
...
|---|---|---|---|---|
| PLAN-TASK-001 | SPEC-COMPAT-008, SPEC-SAFE-004, SPEC-SAFE-005 | no | Package vendoring is mechanical source migration. | Individual package builds and import-boundary checks. |
| PLAN-TASK-002 | SPEC-DATA-001, SPEC-COMPAT-003 | yes | red path/listing tests -> green helper functions -> targeted tests. | N/A |
| PLAN-TASK-003 | SPEC-IF-001, SPEC-DATA-006, SPEC-SAFE-003 | yes | red extraction/manifest/safety tests -> green extractor -> targeted tests. | N/A |
| PLAN-TASK-004 | SPEC-DATA-004, SPEC-ERR-001 | yes | red multi-page/temp/retry tests -> green exporter -> targeted tests. | N/A |
| PLAN-TASK-005 | SPEC-IF-002, SPEC-DATA-002, SPEC-DATA-003 | yes | red VZI smoke/mapping tests -> green capture/orchestrator -> targeted tests. | N/A |
| PLAN-TASK-006 | SPEC-FR-002, SPEC-IF-008, SPEC-SAFE-002 | yes | red archive route success/failure tests -> green route orchestration -> targeted tests. | N/A |
| PLAN-TASK-007 | SPEC-OBS-001, SPEC-OBS-002 | yes | red UI feedback tests -> green UI/i18n -> targeted tests. | N/A |
| PLAN-TASK-008 | SPEC-IF-003 through SPEC-IF-006 | yes | red MCP gate/read tests -> green tools/read layer -> targeted tests. | N/A |
| PLAN-TASK-009 | SPEC-IF-007, SPEC-COMPAT-004 | yes | red export format tests -> green export branches -> targeted tests. | N/A |
| PLAN-TASK-010 | SPEC-COMPAT-001, SPEC-COMPAT-002 | yes | red/preserve regression tests -> keep gate scoped -> targeted tests. | N/A |
| PLAN-TASK-011 | SPEC-SAFE-001 | no | Template guidance is documentation/package content. | Template presence tests and MCP help tests. |
| PLAN-TASK-012 | SPEC-SAFE-004, SPEC-COMPAT-006 | no | Final verification task. | Build, typecheck, tests, and import-boundary checks. |
...
|---|---|---|---|---|
| Core path/storage tests | Generated siblings do not affect versions. | `pnpm vitest run packages/core/tests/artifact-paths.test.ts packages/core/tests/artifact-store.test.ts` | Pass | SPEC-DATA-001, SPEC-COMPAT-003 |
| Icon extraction tests | SVG/PNG/manifest/safety correctness. | `pnpm vitest run packages/core/tests/artifact-icon-extraction.test.ts` | Pass | SPEC-IF-001, SPEC-DATA-006, SPEC-SAFE-003 |
| Requirement icon export tests | Multi-page/temp/retry behavior. | `pnpm vitest run packages/core/tests/requirement-icon-export.test.ts` | Pass | SPEC-FR-001, SPEC-DATA-004, SPEC-ERR-001 |
| VZI capture/orchestration tests | Viewport, decode, bounds, asset refs. | `pnpm vitest run packages/core/tests/requirement-vzi-capture.test.ts packages/core/tests/archive-asset-export.test.ts` | Pass | SPEC-IF-002, SPEC-DATA-002, SPEC-DATA-003 |
| Server archive tests | Success/failure/status commit order. | `pnpm vitest run packages/server/tests/routes.test.ts` | Pass | SPEC-FR-002, SPEC-IF-008, SPEC-SAFE-002 |
| Web API/UI tests | Response typing and count/error feedback. | `pnpm vitest run packages/web/src/api.test.ts packages/web/src/pages/ProductDetail.test.tsx packages/web/src/i18n.test.ts` | Pass | SPEC-OBS-001, SPEC-OBS-002 |
| MCP tool tests | Dev gate, VZI reads, export formats, preserve old tools. | `pnpm vitest run packages/mcp/tests/tools.test.ts` | Pass | SPEC-IF-003 through SPEC-IF-007, SPEC-COMPAT-002 |
| CLI/template tests | Development template packaging. | `pnpm vitest run packages/cli/tests/design-commands.test.ts` | Pass | SPEC-SAFE-001 |
| Vendored package builds | VZI packages compile independently. | `pnpm --filter @vzi-core/types build && pnpm --filter @vzi-core/parser build && pnpm --filter @vzi-core/transformer build && pnpm --filter @vzi-core/format build && pnpm --filter @vzi-core/renderer build` | Pass | SPEC-COMPAT-008 |
| Renderer import boundary | CanvasKit/renderer not in runtime paths. | `rg -n '@vzi-core/renderer|canvaskit-wasm' packages/core packages/server packages/cli packages/mcp/src` plus an automated test/script if added | No forbidden runtime imports | SPEC-SAFE-005, SPEC-COMPAT-006 |
| Workspace build | Cross-package build integration. | `pnpm build` | Pass | SPEC-SAFE-004 |
| Workspace typecheck | Type safety across packages. | `pnpm typecheck` | Pass | SPEC-SAFE-004 |
...
| DESIGN | DES-PLAN-001 | PLAN-TASK-003 | covered |
| DESIGN | DES-PLAN-002 | PLAN-TASK-005, PLAN-TASK-006 | covered |
| DESIGN | DES-PLAN-003 | PLAN-TASK-002 | covered |
| DESIGN | DES-PLAN-004 | PLAN-TASK-005 | covered |
| DESIGN | DES-PLAN-005 | PLAN-TASK-006, PLAN-TASK-007 | covered |
| DESIGN | DES-PLAN-006 | PLAN-TASK-008 | covered |
| DESIGN | DES-PLAN-007 | PLAN-TASK-009 | covered |
| DESIGN | DES-PLAN-008 | PLAN-TASK-010 | covered |
| DESIGN | DES-PLAN-009 | PLAN-TASK-001, PLAN-TASK-012 | covered |
| DESIGN | DES-PLAN-010 | PLAN-TASK-001, PLAN-TASK-012 | covered |
| DESIGN | DES-PLAN-011 | PLAN-TASK-005, PLAN-TASK-008 | covered |
| DESIGN | DES-PLAN-012 | PLAN-TASK-004, Rollback / Safety Plan | covered |
| DESIGN | DES-PLAN-013 | Execution Sequencing | covered |
| SPEC | SPEC-PLAN-001 through SPEC-PLAN-017 | PLAN-TASK-001 through PLAN-TASK-012 | covered |
