...
### PLAN-TASK-003 manifest forma.productIcon 字段与校验（SPEC-DATA-001）
...
### PLAN-TASK-004 component-baseline.ts 单一事实源数据（B7/SPEC-DATA-003）
...
### PLAN-TASK-005 激活当前组件库指针（B2/B7 核心，SPEC-BEHAVIOR-008/SPEC-DATA-002）
...
### PLAN-TASK-007 fm-refine-components 产出产品设计系统（B2/SPEC-BEHAVIOR-007）
