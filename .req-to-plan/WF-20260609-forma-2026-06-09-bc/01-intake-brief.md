...
work_id: WF-20260609-forma-2026-06-09-bc
requirement: # Forma 命令重构 + 后台画布 合并需求文档
...
## Evidence Block
keywords_hit: ['重写', '改成', '转换', '替代', '替换', 'r', 'react', '仓库', '删除', '清理', '下线', 'delete', '角色', '令牌', 'token', 'token', '调用', '依赖', 'mcp', 'mcp', '整个', '全部', '批量']
repo_baseline_summary: loc=118457, modules=85, monorepo=True, languages=['TypeScript', 'JavaScript']
linked_context: - codex/fm-rollback-design/SKILL.md: local_missing
  error: File not found: /Users/xubo/x-studio/forma/codex/fm-rollback-design/SKILL.md
scope_signals: ['整个', '全部', '批量']
