...
r2p_version: 3
r2p_status: approved
r2p_created_at: 2026-06-13T20:11:56.809702+00:00
r2p_updated_at: 2026-06-13T20:24:00.791427+00:00
---
...
Skeleton:
```ts
// 规范文件名以本任务为准：brand-icon-derive.ts（上游 design/spec 散见的 "icon-derive.ts" 旧称以此为正名）
...
### PLAN-TASK-008 后台产品页品牌资产设置 UI + 服务端路由 + i18n
