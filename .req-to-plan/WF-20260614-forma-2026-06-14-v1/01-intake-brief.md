...
work_id: WF-20260614-forma-2026-06-14-v1
requirement: # Forma 品牌资产生成治理需求设计文档
...
## Evidence Block
keywords_hit: ['重写', '改成', '迁移', '替换', 'c', 'project', '删除', '清理', '关闭', '凭证', '计费', '破坏性', '调用', '依赖', 'mcp', 'mcp', '整个', '全部', '所有', '全套', 'full']
repo_baseline_summary: loc=134336, modules=88, monorepo=True, languages=['TypeScript', 'JavaScript']
linked_context: - https://developers.openai.com/api/docs/models/gpt-image-2: unreachable
  error: URL fetching disabled
- https://platform.openai.com/docs/models/gpt-image-1.5: unreachable
  error: URL fetching disabled
- https://ai.google.dev/gemini-api/docs/models/gemini-3-pro-image: unreachable
  error: URL fetching disabled
- https://ai.google.dev/gemini-api/docs/image-generation: unreachable
  error: URL fetching disabled
scope_signals: ['整个', '全部', '所有', '全套', 'full']
