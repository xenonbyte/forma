...
import { HANDOFF_SCHEMA_VERSION, type HandoffRequest, type HandoffResponse } from "../src/api/handoff";
...
describe("handoff contract", () => {
  ...
  it("HandoffRequest round-trips through JSON with the full shape preserved", () => {
    ...
    expect(Object.keys(restored).sort()).toEqual(["apiKey", "baseUrl", "conversationId", "maxTokens", "model"]);
