...
export type ArtifactExportKind = "html" | "pdf" | "zip" | "pptx" | "jsx" | "md" | "svg" | "txt" | "icons" | "vzi";
...
export type ArtifactProvenanceTaskKind = "new-generation" | "code-migration" | "figma-migration" | "tune-collab";
...
export type ArtifactProvenanceRenderKind = "html" | "jsx" | "pptx" | "markdown" | "video" | "image" | "diff" | "repo";

export type ArtifactProvenanceHandoffKind = "design-only" | "implementation-plan" | "patch" | "deployable-app";

export type ArtifactExportSurface = "cli" | "desktop" | "web" | "docker" | "github" | "figma" | "code-agent";

export type ArtifactDeployProvider = "aws" | "gcp" | "azure" | "aliyun" | "tencent" | "huawei" | "self-hosted";
