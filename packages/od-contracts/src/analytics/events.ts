...
import type { TrackingConfigureAvailability, TrackingConfigureType } from "./public-params.js";
...
export type TrackingNewProjectTab = "prototype" | "live_artifact" | "slide_deck" | "from_template" | "media" | "other";
...
export type TrackingFileType = "image" | "video" | "audio" | "pdf" | "zip" | "folder" | "other";

export type TrackingFileSizeBucket = "0_1mb" | "1_10mb" | "10_100mb" | "100mb_plus";
...
export type TrackingOnboardingArea = "runtime" | "about_you" | "design_system" | "generation_progress";
...
export type TrackingOnboardingStepName = "connect" | "about_you" | "design_system" | "generation";
...
export type TrackingDesignSystemsViewType = "page" | "panel" | "dialog" | "popover" | "module";
...
export interface GenericPageViewProps {
  page_name: Exclude<TrackingPageName, "onboarding" | "design_system_project" | "studio">;
...
export type PageViewProps = GenericPageViewProps | OnboardingPageViewProps | DesignSystemsPageViewProps;
...
export interface HelpPopoverClickProps {
  ...
  element: "get_help_on_github" | "submit_a_feature_request" | "whats_new" | "download_desktop_app";
  surface: "popover";
}
...
export interface ExecutionSettingsPopoverClickProps {
  ...
  element: "mode_local_cli" | "mode_byok" | "agent_card" | "model_dropdown" | "open_execution_settings";
}

export interface SettingsPopoverClickProps {
  page_name: "home";
  area: "settings_popover";
  element: "follow_x" | "join_discord" | "language" | "appearance" | "use_everywhere" | "settings";
}

export interface HomeChatComposerClickProps {
  page_name: "home";
  area: "chat_composer";
  element: "chat_input" | "send_button" | "plugin_chip" | "action_chip";
...
export interface ProjectsListControlsClickProps {
  page_name: "projects";
  area: "list_controls";
  element: "recent" | "your_designs" | "search_input" | "select" | "grid_view" | "list_view";
}
...
export interface AutomationsClickProps {
  ...
  area: "automations";
  element: "new_automation" | "new" | "view_progress" | "run_now" | "open_artifact" | "type_card" | "filter_tab";
...
export interface DesignSystemsTemplatesModalClickProps {
  ...
  element: "showcase" | "tokens" | "design_md" | "open_design_set" | "fullscreen" | "share";
  templates_id?: string;
  templates_type?: string;
}
...
export interface SettingsByokFieldClickProps {
  page_name: TrackingSettingsPage;
  area: "configure_execution_mode_byok";
  element: "fetch_models" | "test" | "quick_fill_provider" | "api_key" | "model" | "memory_model" | "base_url";
  provider_id: TrackingByokProviderId;
...
export interface SettingsNotificationsClickProps {
  page_name: TrackingSettingsPage;
  area: "notifications";
  element: "completion_sound" | "desktop_notification" | "send_test" | "success_sound" | "failure_sound";
...
export interface SettingsPetsClickProps {
  page_name: TrackingSettingsPage;
  area: "pets";
  element: "tuck_away" | "built_in" | "custom" | "community" | "custom_card" | "adopt";
  pet_id?: string;
}
...
export interface SettingsPrivacyClickProps {
  page_name: TrackingSettingsPage;
  area: "privacy";
  element: "anonymous_metrics" | "conversation_and_tool_content" | "project_artifacts_manifest" | "delete_my_data";
...
export function projectKindToTracking(kind: string | null | undefined): TrackingProjectKind | null {
  switch (kind) {
    case "prototype":
      return "prototype";
    case "deck":
...
export function fidelityToTracking(fidelity: string | null | undefined): TrackingFidelity {
...
export function executionModeToTracking(mode: string | null | undefined): TrackingExecutionMode {
...
export function byokProtocolToTracking(protocol: string | null | undefined): TrackingByokProviderId | null {
  switch (protocol) {
    case "anthropic":
      return "anthropic";
    case "openai":
...
export function settingsSectionToTracking(section: string): TrackingSettingsArea {
  switch (section) {
    case "execution":
...
export function deriveConfigureGlobals(input: DeriveConfigureGlobalsInput): {
  ...
  const selectedAgent = input.agentId ? agents.find((a) => a.id === input.agentId) : undefined;
