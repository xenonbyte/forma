import { z } from "zod";
import { OPEN_DESIGN_PLUGIN_SPEC_VERSION, OpenDesignSpecVersionSchema } from "./manifest.js";

const MarketplaceEntryDistSchema = z
  .object({
...
const MarketplacePluginVersionSchema = z
  .object({
