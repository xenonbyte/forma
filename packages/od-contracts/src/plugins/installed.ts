...
import { MarketplaceTrustSchema, TrustTierSchema, type MarketplaceTrust, type TrustTier } from "./marketplace.js";
...
export const PluginSourceKindSchema = z.enum(["bundled", "user", "project", "marketplace", "github", "url", "local"]);
