...
describe("artifact-paths", () => {
  ...
  it("getArtifactManifestPath", () => {
    expect(getArtifactManifestPath(root, pid, aid)).toBe(
      "/data/products/P-abc123/od-project/artifacts/AbCdEfGhIjKlMnOp/manifest.json",
    );
  });

  it("getArtifactPreviewPath 1x", () => {
    expect(getArtifactPreviewPath(root, pid, aid, "1x")).toBe(
      "/data/products/P-abc123/od-project/artifacts/AbCdEfGhIjKlMnOp/preview/1x.png",
    );
  });

  it("getArtifactPreviewPath 2x", () => {
    expect(getArtifactPreviewPath(root, pid, aid, "2x")).toBe(
      "/data/products/P-abc123/od-project/artifacts/AbCdEfGhIjKlMnOp/preview/2x.png",
    );
  });
