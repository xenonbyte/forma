...
export const messages: Record<Locale, Record<string, string>> = {
  en: {
    ...
    "product.requiredFieldsHelp": "Name, description, platform, product style, and language configuration are required before creation.",
  ...
  zh: {
    ...
    "product.requiredFieldsHelp": "创建前需要填写名称、描述、平台、产品风格和语言配置。",
