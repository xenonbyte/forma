---
description: Upload a new Forma requirement through MCP.
---

# Forma route: fm-upload-requirement

Use shared Forma guidance at ~/.forma/skills/forma/SKILL.md.

Execution:
1. Read current session through MCP.
2. Fetch latest requirement to avoid replacing active context accidentally.
3. Confirm operation with product, requirement, and pending or expired pages.
4. Construct the requirement upload prompt.
