// P9.6 dogfood — 页面标注画布 (page annotation canvas).
//
// IMPORTANT — the shell chrome here is INTENTIONALLY IDENTICAL to the page DESIGN
// canvas (page-design.dogfood.browser.test.tsx). design vs annotation is purely a
// MODE INSIDE <Viewer> (top toggle [data-action="mode-design"] /
// [data-action="mode-annotation"]); the desktop shell router has NO design/annotation
// distinction (same hash #/products/p1/requirements/r1/pages/login, same
// Sidebar/TopBar/Workspace). So there is no shell-level difference to assert — the
// only thing that would differ is the viewer's internal canvas (design iframes vs
// annotation imgs).
//
