...
export function registerFormaIpcHandlers(
  ...
  ipcMain.handle('forma:listArtifacts', (_event, productId) => client.listArtifacts(requireIpcString(productId, 'productId')));
  ...
  ipcMain.handle('forma:listRequirements', (_event, productId) => client.listRequirements(requireIpcString(productId, 'productId')));
