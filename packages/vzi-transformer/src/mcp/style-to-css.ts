...
export function fillStyleToCss(styles: IRStyles): string {
  const fillProperties = ['background', 'backgroundColor', 'backgroundImage', 'backgroundSize', 'backgroundPosition', 'backgroundRepeat'];
...
export function strokeStyleToCss(styles: IRStyles): string {
  const strokeProperties = ['border', 'borderWidth', 'borderStyle', 'borderColor', 'borderRadius', 'borderTop', 'borderRight', 'borderBottom', 'borderLeft'];
  const filteredStyles: IRStyles = {};
...
export function textStyleToCss(styles: IRStyles): string {
  const textProperties = ['color', 'fontSize', 'fontFamily', 'fontWeight', 'fontStyle', 'lineHeight', 'letterSpacing', 'textAlign', 'textDecoration', 'textTransform', 'whiteSpace', 'wordBreak'];
  const filteredStyles: IRStyles = {};
